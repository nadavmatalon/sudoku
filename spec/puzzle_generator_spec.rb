...
#         expect(unsolved_puzzle.to_str).to eq '0' * 81
#       end
#     end
...
#         solved_puzzle.punch(10)
#         expect(solved_puzzle.solved_squares_count).to eq 71
#       end
#     end
...
#         expect{ empty_puzzle.upload_new_puzzle }.not_to raise_error
#       end

#       it 'can be doen with a specified difficulty level' do
#         expect{ empty_puzzle.upload_new_puzzle(1) }.not_to raise_error
#       end

#       it 'can only be done with a single difficulty level' do
#         expect{ empty_puzzle.upload_new_puzzle(1, 2) }.to raise_error(ArgumentError)
#       end
...
#           expect{ empty_puzzle.upload_new_puzzle(arg) }.to raise_error(TypeError, type_err_msg)
#         end
#       end
...
#           empty_puzzle.upload_new_puzzle
#           expect(empty_puzzle.solved_squares_count).to eq 30
#         end
#       end
#     end
